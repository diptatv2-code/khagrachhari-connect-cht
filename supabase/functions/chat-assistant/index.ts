...
- ব্যাংক (banks) — লেনদেন, একাউন্ট, লোন, পূবালী ব্যাংক, সোনালী ব্যাংক
...
- গাড়ি ভাড়া ও CNG (transport) — যানবাহন, ভাড়া, CNG, জীপ
...
3. প্রাসঙ্গিক সেবার লিংক দিতে [ACTION:service_id] ফরম্যাট ব্যবহার করো। যেমন: [ACTION:health], [ACTION:banks], [ACTION:hotels], [ACTION:tourist], [ACTION:transport]
